...
#Model Evaluation
Accuracy_score = [LR_accuracy,SVC_accuracy,GBC_accuracy]
Precision_score = [LR_precision,SVC_precision,GBC_precision]
F1_score = [LR_f1,SVC_f1,GBC_f1]
Recall_score = [LR_recall,SVC_recall,GBC_recall]

indexes = ["Logistic Regression", "Support Vector Machine","Gradient Boosting"]
